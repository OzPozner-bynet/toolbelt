 ...
 # hmus_oids_r = ""
  ...
  hmus_OIDs = {
               # :winlink1000OduAirLinkDistance => '1.3.6.1.4.1.4458.1000.1.5.29.0',
				...
				:HMU_AirTotalTxPower => '1.3.6.1.4.1.4458.1000.1.5.50.0',
				:HMU_AirState => '1.3.6.1.4.1.4458.1000.4.1.1.0',
				:HMU_AirLinkState => '1.3.6.1.4.1.4458.1000.4.1.2.0',
			#	:winlink1000HsuAirRemoteCompressedMon => '1.3.6.1.4.1.4458.1000.4.1.6.0',
			#	
			#	:HMU_OduAirSesState => '1.3.6.1.4.1.4458.1000.1.5.5.0',
			    :HMU_OduAirRxPower => '1.3.6.1.4.1.4458.1000.1.5.9.1.0' 
			  }
